...
Examples:
1. <code>{escape('<b>@GlitchInLuck</b>')}</code> 
This will give output of:
<b>@GlitchInLuck</b>  <code>50MB.bin</code>.

2. <code>{escape('<code>@GlitchInLuck</code>')}</code> 
This will give output of:
<code>@GlitchInLuck</code> <code>50MB.bin</code>.
